...
public:
    ...
    ReverseMultiStringFactorGraph(const std::string &start_end_symbol)
        : start_end_symbol(start_end_symbol) {
        nodes.push_back(Node(std::string(start_end_symbol)));
    };
    ~ReverseMultiStringFactorGraph();
